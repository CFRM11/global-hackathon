...
export default function App() {
  ...
  const startJourney = useCallback(async (input: string) => {
    ...
    setError(null);
    try {
      const res = await getPathfinderPath(input, [], selectedTags);
      setResponse(res);
  ...
  const selectOption = useCallback(async (option: Option) => {
    ...
    try {
      const res = await getPathfinderPath(userInput, newHistory, selectedTags);
      setResponse(res);
  ...
  }, [history, userInput, selectedTags]);
  ...
  const regeneratePlan = async () => {
    ...
    setError(null);
    try {
      const res = await getPathfinderPath(userInput, history, selectedTags);
      setResponse(res);
          ...
          {!response && !isLoading && (
            ...
            >
              <div className="space-y-4">
                <h3 className="text-sm font-bold uppercase tracking-widest text-stone-400 text-center">Filtros Activos</h3>
              ...
              <div className="relative">
                <input
                  id="user-input"
                  type="text"
                  placeholder="Describe tu idea vaga..."
                ...
                <div className="space-y-6">
                  <div className="p-8 bg-white border border-[#e7e5e4] rounded-3xl shadow-sm space-y-8 overflow-hidden relative">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#a8a29e] mb-2">Actividad Recomendada</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#a8a29e] mb-2">Detalles del Plan</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#a8a29e] mb-2">Duración Estimada</h4>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-[#a8a29e] mb-2">Tags del Plan</h4>
